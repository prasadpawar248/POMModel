...
//click on samsung fridge 
	@FindBy(xpath="//span[text()='Samsung 189 L 5 Star Inverter Direct-Cool Single Door Refrigerator (RR21C2H25CR/HL, Camellia Purple, Base Stand with Drawer)']")
...
//Price Range
	...
	@FindBy(xpath="//span[text()='₹10,000 - ₹15,000']")WebElement priceRange1000015000;
	...
	@FindBy(xpath="//input[@id='low-price']")WebElement minPrice;
	...
	@FindBy(xpath="//input[@id='high-price']")WebElement maxPrice;
	...
	@FindBy(xpath="//input[@class='a-button-input']")WebElement goBtn;
...
//capture price data
	@FindBy(xpath="//div[@class='a-row a-size-base a-color-base']/a/span/span[2]/span[2]") List<WebElement> samsungProductsPrice;
...
//capacity
	...
	@FindBy(xpath="//li[@id='p_n_feature_seven_browse-bin/1480497031']/span/a/div//i")WebElement capacity121200;
	...
	@FindBy(xpath="//h2[@class='a-size-mini a-spacing-none a-color-base s-line-clamp-2']/a/span")List<WebElement> productDiscription;
...
//Brands
	...
	@FindBy(xpath="//li[@id='p_89/Samsung']//input")WebElement brandSamsung;
...
//Customer review star
	...
	@FindBy(xpath="//i[@class='a-icon a-icon-star-medium a-star-medium-4']")WebElement customerReviewStar;
	...
	@FindBy(xpath="//div[@class='a-row a-size-small']/"
			+ "span/span[3]/a/i/span")List<WebElement> starOnProduct;
...
//Discount
	...
	@FindBy(xpath="//span[text()='25% Off or more']")WebElement dicount25Off;
	public void clickOnDicount25Off()
	{
		dicount25Off.click();
	}
	
	@FindBy(xpath="//div[@class='a-section a-spacing-none a-spacing-top-micro s-price-instructions-style']/div/span[2]")List<WebElement> discount;
...
//Energy star
	@FindBy(xpath="//li[@id='p_n_feature_two_browse-bin/28232662031']/span/a/div//input")WebElement energy2Star;
